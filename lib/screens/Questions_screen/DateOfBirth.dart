                ...
                children: [
                  Expanded(
                      child: Container(
                        ...
                        child: Text('MM', style: TextStyle(color: Colors.grey),),
                      )
                  ),
                  SizedBox(
                    width: 15,
                  ...
                  Expanded(
                      child: Container(
                        alignment: Alignment.center,
                        padding: EdgeInsets.all(6),
                        child: Text('DD', style: TextStyle(color: Colors.grey),),
                      )
                  ),
                  SizedBox(
                    width: 15,
                  ...
                  Expanded(
                      child: Container(
                        alignment: Alignment.center,
                        padding: EdgeInsets.all(6),
                        child: Text('YY', style: TextStyle(color: Colors.grey),),
                      )
                  ),
                ],
              ),
