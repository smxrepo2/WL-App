...
import '../used-Questions/eat_watching_tv.dart';
import 'i_eat_more_when_i_see.dart';

class EatLargePortion extends StatefulWidget {
  SignUpBody signUpBody;

  EatLargePortion({Key key, this.signUpBody}) : super(key: key);

  @override
  _EatLargePortionState createState() => _EatLargePortionState();
}

class _EatLargePortionState extends State<EatLargePortion> {
  String gender = '';
              ...
              children: [
                Column(
                  children: [
                    ...
                    questionHeader(queNo: 36, percent: .87, color: mindBorder),
                    SizedBox(
                      height: height * .05,
                    ),
                    // Row(
                ...
                child: InkWell(
                  onTap: () {
                    if (gender == 'Agree') {
                      ...
                      print(
                          "Eat large${widget.signUpBody.mindQuestions.largeEating}");
