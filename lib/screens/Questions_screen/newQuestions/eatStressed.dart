...
import 'eatBored.dart';

class EatStressedQuestion extends StatefulWidget {
  ...
  @override
  State<EatStressedQuestion> createState() => _EatStressedQuestionState();
}

class _EatStressedQuestionState extends State<EatStressedQuestion> {
  ...
  void initState() {
    ...
    _questoins = _questionsModel.questoins[19];
    ...
    return Scaffold(
      body: Column(
        children: [
                        ...
                        setState(() {
                          ...
                          if (selectedOption == -1) {
                            ...
                            var user = Provider.of<UserDataProvider>(context,
                                listen: false);
                            String eatStressed = data[selectedOption];
                            ...
                            AddEatStressedQuestionRequestModel requestModel =
                                AddEatStressedQuestionRequestModel(
                                    ...
                                    Stress: eatStressed,
                                    QuestionOrder: 20);
                            addEatStressed(requestModel).then((value) {
                              if (value != null) {
                                if (value.response ==
                                    "Data updated successfully") {
                                  AuthService.setQuestionOrder(20);
                                  //Todo: Testing
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
          ...
          GestureDetector(
            onTap: () {
              ...
              if (selectedOption == -1) {
                ...
                AddEatStressedQuestionRequestModel requestModel =
                    AddEatStressedQuestionRequestModel(
                        UserId: userId, Stress: eatStressed, QuestionOrder: 20);
                addEatStressed(requestModel).then((value) {
                  if (value != null) {
                    if (value.response == "Data updated successfully") {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => EatBoredQuestion(
          ...
          // countingText(
          //     number: 20, totalQuestion: _questionsModel.questoins.length),
  ...
  Future<AddEatStressedQuestionResponseModel> addEatStressed(
    ...
    try {
      ...
      AddEatStressedQuestionResponseModel response =
          await _questionRepository.addEatStressed(requestModel);
      EasyLoading.dismiss();
      return response;
    } catch (e) {
      // Get.showSnackbar();
