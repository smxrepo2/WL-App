...
class EatQuickerQuestion extends StatefulWidget {
  ...
  @override
  State<EatQuickerQuestion> createState() => _EatQuickerQuestionState();
}

class _EatQuickerQuestionState extends State<EatQuickerQuestion> {
  ...
  void initState() {
    ...
    _questoins = _questionsModel.questoins[21];
    ...
    return Scaffold(
      body: Column(
        children: [
                          ...
                          if (selectedOption == -1) {
                            ...
                            AddEatQuickerQuestionRequestModel requestModel =
                                AddEatQuickerQuestionRequestModel(
                                    UserId: userId,
                                    EatingRound: eatQuicker,
                                    QuestionOrder: 22);
                            addEatQuicker(requestModel).then((value) {
                              if (value != null) {
                                if (value.response ==
                                    "Data updated successfully") {
                                  //Todo: Testing
                                  AuthService.setQuestionOrder(22);
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) =>
          ...
          // countingText(
          //     number: 22, totalQuestion: _questionsModel.questoins.length),
  ...
  Future<AddEatQuickerQuestionResponseModel> addEatQuicker(
    ...
    try {
      ...
      AddEatQuickerQuestionResponseModel response =
          await _questionRepository.addEatQuicker(requestModel);
      EasyLoading.dismiss();
      return response;
    } catch (e) {
      // Get.showSnackbar();
