...
import 'package:weight_loser/screens/Questions_screen/disturb_sleep.dart';
...
class SleepLessThan7 extends StatefulWidget {
  SignUpBody signUpBody;
  SleepLessThan7({Key key, this.signUpBody}) : super(key: key);

  @override
  _SleepLessThan7State createState() => _SleepLessThan7State();
}

class _SleepLessThan7State extends State<SleepLessThan7> {
  String gender = '';
              ...
              children: [
                Column(
                  children: [
                    ...
                    questionHeader(queNo: 14, percent: .70, color: exBorder),
                    SizedBox(
                      height: height * .05,
                    ),
                    // Row(
            ...
            Positioned(
              ...
              child: Container(
                child: InkWell(
                  onTap: () {
                    if (gender != '') {
                      widget.signUpBody.mindQuestions.sevenSleeping = gender;
                      print(
                          "Sleep ${widget.signUpBody.mindQuestions.sevenSleeping}");
                      mobile
