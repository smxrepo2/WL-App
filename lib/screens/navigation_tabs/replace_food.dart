...
class TrackFood extends StatefulWidget {
  TrackFood(
      {Key key, this.eatingTime, this.foodId, this.planId, this.ispressed})
      : super(key: key);
  int eatingTime;
  int foodId;
  int planId;
                  ...
                  GestureDetector(
                    onTap: () async {
                      await replaceSingleFood(widget.foodId, widget.planId,
                        ...
                        _foodProvider.setData(widget.eatingTime);
                        print("tabitem:" + _foodProvider.getData().toString());
                        _dialog.hide();
                        Navigator.of(context).push(
                            MaterialPageRoute(builder: (_) => BottomBarNew(0)));
                      });
